        ...
        if (status & PTP_CHDK_SCRIPT_STATUS_MSG) {
            ...
            case PTP_CHDK_S_MSGTYPE_USER:
                ...
                case PTP_CHDK_TYPE_TABLE:
                    ...
                    break;
                default:
                    GP_LOG_E("unknown chdk msg->type %d", msg->subtype);
                    break;
                }
                break;
...
nexttable:
        ...
        while (*t) {
            ...
            while (*t && *t != '}') {
                ...
                if (t==strstr(t,"is_file=true")) {
                    isfile = TRUE;
                }
                if (t==strstr(t,"is_file=false")) {
                    isfile = FALSE;
                }
                if (t==strstr(t,"is_dir=true")) {
                    isfile = FALSE;
                }
                if (t==strstr(t,"is_dir=false")) {
                    isfile = TRUE;
                }
                if (t==strstr(t,"name=\"")) {
                    char *s;
