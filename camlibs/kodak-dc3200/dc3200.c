...
int dc3200_check_last_use(Camera *camera)
{
	time_t t;
			     ...
			     GPContext *context)
{
	...
	if(dc3200_check_last_use(camera) == GP_ERROR)
	{
		return GP_ERROR;
	}
	       ...
	       GPContext *context)
{
	...
	info->file.size = dc3200_bytes_to_l(data[19], data[18], data[17], data[16]);
...
CameraLibrary camera_kodak_dc3200_library = {
    .id = "kodak-dc3200",
